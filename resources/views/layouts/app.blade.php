...
@yield('css')
    ...
    <!-- file upload -->
    <script src="{{ asset('/js/js/vendor/jquery.ui.widget.js') }}"></script>
    <script src="{{ asset('/js/js/jquery.iframe-transport.js') }}"></script>
    <script src="{{ asset('/js/js/jquery.fileupload.js') }}"></script>
    <!-- end file upload -->
   {{--  <script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.15.1/moment.min.js"></script> --}}
    ...
    <script src="{{ asset('/js/esta_madre.js') }}"></script>
...
<!--fin Modal add elementos -->

<!--Modal edit elementos -->
